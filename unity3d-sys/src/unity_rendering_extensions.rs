...
pub enum UnityRenderingExtEventType {
    SetStereoTarget, // issued during SetStereoTarget and carrying the current 'eye' index as parameter
    SetStereoEye, // issued during stereo rendering at the beginning of each eye's rendering loop. It carries the current 'eye' index as parameter
    StereoRenderingDone, // issued after the rendering has finished
    BeforeDrawCall, // issued during BeforeDrawCall and carrying UnityRenderingExtBeforeDrawCallParams as parameter
    AfterDrawCall, // issued during AfterDrawCall. This event doesn't carry any parameters
    CustomGrab, // issued during GrabIntoRenderTexture since we can't simply copy the resources
    ...
    CustomBlit, // issued by plugin to insert custom blits. It carries over UnityRenderingExtCustomBlitParams as param.
    UpdateTextureBegin, // Deprecated.
    UpdateTextureEnd, // Deprecated.
    // UpdateTextureBeginV1 = UpdateTextureBegin, // Deprecated. Issued to update a texture. It carries over UnityRenderingExtTextureUpdateParamsV1
    // UpdateTextureEndV1 = UpdateTextureEnd, // Deprecated. Issued to signal the plugin that the texture update has finished. It carries over the same UnityRenderingExtTextureUpdateParamsV1 as UpdateTextureBeginV1
    UpdateTextureBeginV2, // Issued to update a texture. It carries over UnityRenderingExtTextureUpdateParamsV2
    UpdateTextureEndV2, // Issued to signal the plugin that the texture update has finished. It carries over the same UnityRenderingExtTextureUpdateParamsV2 as UpdateTextureBeginV2
...
impl UnityRenderingExtEventType {
    ...
    pub const UserEventsStart: UnityRenderingExtEventType =
        UnityRenderingExtEventType::Count;
}
