...
pub struct IUnityGraphicsD3D11 {
    ...
    pub texture_from_render_buffer:
        unsafe extern "system" fn(buffer: UnityRenderBuffer) -> *const std::os::raw::c_void,
    pub texture_from_native_texture:
        unsafe extern "system" fn(id: UnityTextureID) -> *const std::os::raw::c_void,
    pub rtv_from_render_buffer:
        unsafe extern "system" fn(buffer: UnityRenderBuffer) -> *const std::os::raw::c_void,
    pub srv_from_native_texture:
        unsafe extern "system" fn(id: UnityTextureID) -> *const std::os::raw::c_void,
}
